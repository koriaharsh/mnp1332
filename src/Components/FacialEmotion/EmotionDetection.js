...
function EmotionDetection() {
  ...
  const detect = async (net) => {
    if (
      ...
      // Websocket
      var socket = new WebSocket('ws://localhost:8000/emotion/');
      ...
      <div className="emotion-detection-container">
        ...
        />    */}
          ...
          >
            ...
            <br></br>
            <br></br>
            <label forhtml="Neutral" style={{ color: 'green' }}>
              Neutral{' '}
            </label>
            ...
            <br></br>
            <br></br>
            <label forhtml="Fear" style={{ color: 'blue' }}>
              Fear{' '}
            </label>
            ...
            <br></br>
            <br></br>
            <label forhtml="Surprise" style={{ color: 'yellowgreen' }}>
              Surprised{' '}
            </label>
            ...
            <br></br>
            <br></br>
            <label forhtml="Sad" style={{ color: 'black' }}>
              Sad{' '}
            </label>
            ...
            <br></br>
            <br></br>
            <label forhtml="Disgust" style={{ color: 'darkmagenta' }}>
              Disgusted{' '}
            </label>
