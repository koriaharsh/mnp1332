  ...
  return (
    <Timeline position="alternate">
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          STEP-4 Once the visualization starts you can pause and restart it by
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          STEP-5 To disconnect the device press disconnect button and now you
          can turn off the bluetooth
        </TimelineContent>
      </TimelineItem>
    </Timeline>
  );
